...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
    ...
    <form action="{{ url('updateposts',$post->id) }}" method="POST" enctype="multipart/form-data">
    	@csrf
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input id="image" type="file" value="{{ $post->image }}" name="image" class="btn-success"><br><br>
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            ...
		            <textarea class="form-control detail" style="height:150px" id="detail" name="detail" placeholder="Enter Content">{{ $post->detail }}</textarea>
		        </div>
            </div>
