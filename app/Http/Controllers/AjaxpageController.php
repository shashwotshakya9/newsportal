...
class AjaxpageController extends Controller
{
    ...
    {
        $ajaxpages = Ajaxpage::latest()->get();
        
        if ($request->ajax()) {
            $data = Ajaxpage::latest()->get();
        ...
        return view('ajaxpage.index',compact('ajaxpages'));
    }
    ...
    {
        Ajaxpage::updateOrCreate(['id' => $request->data_id],
                ['name' => $request->name, 'publish' => $request->publish]);        
    ...
    {
        $ajaxpage = Ajaxpage::find($id);
        return response()->json($ajaxpage);
    }
